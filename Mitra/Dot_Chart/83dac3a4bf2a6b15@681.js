...
Percentage of homeless population by year and state.`
)});
...
legend({title: "Population (years)", color, tickSize: 0})
)});
  main.variable(observer("chart")).define("chart", ["d3","width","height","xAxis","data","y","x","keys","color"], function(d3,width,height,xAxis,data,y,x,keys,color)
{
  ...
  main.variable(observer()).define(["d3","data","primary","chart"], function(d3,data,primary,chart)
{
